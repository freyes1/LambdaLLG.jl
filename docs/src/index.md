...
terms in 1D, optional 1D and 2D spin-transfer torque, and directional
nearest-neighbor DMI terms in 2D.

## Features

- 1D and 2D lattice LLG evolution with open boundaries.
- 1D bulk DMI with a translationally invariant bond vector.
- Optional 1D and 2D Zhang-Li spin-transfer torque for current-driven dynamics.
